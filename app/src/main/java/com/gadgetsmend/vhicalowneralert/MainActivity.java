...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SaveSharedPreference.getVehicleNo(this).length() == 0) {
            ...
            /*
            Button btn1 = (Button) findViewById(R.id.shareButton) ;
    ...
    public void onResume() {
        super.onResume();
        if (this.getIntent().getBooleanExtra("fromnotification", false) == true) {
    ...
    void sendEmergency(final String alert_message, final String alert_area) {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, wrapper> {
            wrapper w = new wrapper();
            ProgressDialog dialog = ProgressDialog.show(MainActivity.this, "", "Sending emergency alert ...", true);
